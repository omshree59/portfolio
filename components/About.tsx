...
export default function About() {
  ...
  return (
    <section 
      ref={containerRef}
      className="bg-[#0a0a0a] min-h-screen py-24 md:py-32 px-6 md:px-20 flex items-center relative z-20 overflow-hidden"
    >
      
      {/* 🏎️ CINEMATIC F1 TRACK BACKGROUND 🏎️ */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {/* Slow breathing/panning animation on the background image with subtle scroll parallax */}
        <motion.div
          ...
          animate={shouldReduceMotion ? {} : { scale: [1.1, 1.18, 1.1] }}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        <div className="flex gap-4 md:gap-8 justify-center h-[500px] md:h-[700px] overflow-hidden">
          ...
          <motion.div style={{ y: leftColumnY }} className="flex flex-col gap-4 md:gap-8 w-1/2 pt-12">
            <div 
              ...
              style={{ backgroundImage: "url(https://raw.githubusercontent.com/omshree59/movie-assets/main/posters/about1.webp)" }}
            />
            <div 
              className="w-full h-[280px] md:h-[400px] rounded-2xl bg-cover bg-center transition-all duration-700 hover:sepia hover:contrast-125 hover:saturate-50 shadow-2xl"
              style={{ backgroundImage: "url(https://raw.githubusercontent.com/omshree59/movie-assets/main/posters/about2.webp)" }}
            />
          </motion.div>
          ...
          <motion.div style={{ y: rightColumnY }} className="flex flex-col gap-4 md:gap-8 w-1/2 pb-12">
            <div 
              className="w-full h-[280px] md:h-[400px] rounded-2xl bg-cover bg-center transition-all duration-700 hover:sepia hover:contrast-125 hover:saturate-50 shadow-2xl"
              style={{ backgroundImage: "url(https://raw.githubusercontent.com/omshree59/movie-assets/main/posters/about3.webp)" }}
            />
            <div 
              className="w-full h-[280px] md:h-[400px] rounded-2xl bg-cover bg-center transition-all duration-700 hover:sepia hover:contrast-125 hover:saturate-50 shadow-2xl"
              style={{ backgroundImage: "url(https://raw.githubusercontent.com/omshree59/movie-assets/main/posters/about4.webp)" }}
            />
          </motion.div>
        </div>
        ...
        <div className="flex flex-col justify-center pointer-events-auto">
          ...
          <motion.div
            ...
            className="backdrop-blur-sm bg-black/20 p-6 md:p-8 rounded-2xl border border-white/5 will-change-transform will-change-opacity"
          >
